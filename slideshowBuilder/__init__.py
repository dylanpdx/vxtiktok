...
def generateVideo(slideshowVideoData):
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        subprocess.run(["ffmpeg", "-f", "concat", "-safe", "0", "-protocol_whitelist", "file,http,tcp,https,tls", "-i", txtPath, "-i", musicPath, "-map", "0:v", "-map", "1:a","-vf","scale=1280:720:force_original_aspect_ratio=decrease:eval=frame,pad=1280:720:-1:-1:eval=frame,format=yuv420p", "-shortest", outputFilePath])
